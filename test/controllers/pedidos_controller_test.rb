...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { empleado_id: @pedido.empleado_id, fecha: @pedido.fecha, tipopedido: @pedido.tipopedido } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { empleado_id: @pedido.empleado_id, fecha: @pedido.fecha, tipopedido: @pedido.tipopedido } }
