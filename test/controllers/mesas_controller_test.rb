...
class MesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post mesas_url, params: { mesa: { cantidadpersonas: @mesa.cantidadpersonas, ubicacion: @mesa.ubicacion } }
    end
  ...
  test "should update mesa" do
    patch mesa_url(@mesa), params: { mesa: { cantidadpersonas: @mesa.cantidadpersonas, ubicacion: @mesa.ubicacion } }
