...
class PlatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plato" do
    assert_difference('Plato.count') do
      post platos_url, params: { plato: { descripcion: @plato.descripcion, nombre: @plato.nombre, precio: @plato.precio, tipo: @plato.tipo } }
    end
  ...
  test "should update plato" do
    patch plato_url(@plato), params: { plato: { descripcion: @plato.descripcion, nombre: @plato.nombre, precio: @plato.precio, tipo: @plato.tipo } }
