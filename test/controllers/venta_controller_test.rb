...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { fecha: @ventum.fecha, iva: @ventum.iva, numero: @ventum.numero, pedido_id: @ventum.pedido_id, propina: @ventum.propina, subtotal: @ventum.subtotal, tipo: @ventum.tipo, total: @ventum.total } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { fecha: @ventum.fecha, iva: @ventum.iva, numero: @ventum.numero, pedido_id: @ventum.pedido_id, propina: @ventum.propina, subtotal: @ventum.subtotal, tipo: @ventum.tipo, total: @ventum.total } }
