...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { direccion: @proveedor.direccion, mail: @proveedor.mail, nombre: @proveedor.nombre, rut: @proveedor.rut, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { direccion: @proveedor.direccion, mail: @proveedor.mail, nombre: @proveedor.nombre, rut: @proveedor.rut, telefono: @proveedor.telefono } }
