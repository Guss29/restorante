...
class InsumosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post insumos_url, params: { insumo: { cantidad: @insumo.cantidad, nombre: @insumo.nombre, unidadmedida: @insumo.unidadmedida } }
    end
  ...
  test "should update insumo" do
    patch insumo_url(@insumo), params: { insumo: { cantidad: @insumo.cantidad, nombre: @insumo.nombre, unidadmedida: @insumo.unidadmedida } }
